...
def get_protocols_tutor(user_id: int,
                        db: Session) -> list[schemas.ProtocolShort]:
...
def get_protocol(protocol_id: int, db: Session) -> Optional[schemas.Protocol]:
    ...
    return schemas.Protocol(
        ...
        use_of_learning_methods_mark_fk=protocol.
...
def get_course_protocol(protocol_id: int,
                        db: Session) -> Optional[schemas.Course]:
...
def get_protocols_comission_head(user_id: int,
                                 db: Session) -> list[schemas.ProtocolEdit]:
...
def update_protocol(protocol: models.Protocol, protocol_id: int,
                    db: Session) -> Optional[schemas.Protocol]:
...
def get_audits_schedule(user_id: int,
                        db: Session) -> Optional[list[schemas.AuditsSchedule]]:
...
def get_audits_details(audit_id: int,
                       db: Session) -> Optional[schemas.AuditsDetails]:
    ...
    r = db.query(models.Audit.date, models.Audit.id, models.Course.code,
                 models.Course.name, models.User.name, models.User.surname,
