"""First test.db revision

Revision ID: 7ef3036c62a3
Revises: 
Create Date: 2022-03-02 15:36:37.958196
...
def upgrade():
    ...
    sa.Column('conclusions_and_recommendations', sa.String(), nullable=True),
    ...
    sa.Column('use_of_learning_methods_mark_fk', sa.Float(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['control_mark_fk'], ['mark.mark'], ),
    sa.ForeignKeyConstraint(['creation_mark_fk'], ['mark.mark'], ),
    sa.ForeignKeyConstraint(['explanation_mark_fk'], ['mark.mark'], ),
    sa.ForeignKeyConstraint(['inspiration_mark_fk'], ['mark.mark'], ),
    sa.ForeignKeyConstraint(['participation_mark_fk'], ['mark.mark'], ),
    sa.ForeignKeyConstraint(['presentation_mark_fk'], ['mark.mark'], ),
    sa.ForeignKeyConstraint(['realization_mark_fk'], ['mark.mark'], ),
    sa.ForeignKeyConstraint(['use_of_learning_methods_mark_fk'], ['mark.mark'], ),
    sa.ForeignKeyConstraint(['use_of_tools_mark_fk'], ['mark.mark'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['protocol_fk'], ['protocol.id'], ),
    sa.ForeignKeyConstraint(['user_fk'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_appeal_id'), 'appeal', ['id'], unique=False)
    op.create_index(op.f('ix_appeal_protocol_fk'), 'appeal', ['protocol_fk'], unique=False)
    op.create_index(op.f('ix_appeal_user_fk'), 'appeal', ['user_fk'], unique=False)
    ...
    op.create_index(op.f('ix_audit_commission_id'), 'audit_commission', ['id'], unique=False)
    op.create_index(op.f('ix_audit_commission_user_fk'), 'audit_commission', ['user_fk'], unique=False)
    ...
    op.create_index(op.f('ix_course_user_fk'), 'course', ['user_fk'], unique=False)
    ...
    sa.Column('protocol_fk', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['audit_commission_fk'], ['audit_commission.id'], ),
    sa.ForeignKeyConstraint(['course_fk'], ['course.id'], ),
    sa.ForeignKeyConstraint(['protocol_fk'], ['protocol.id'], ),
    sa.ForeignKeyConstraint(['schedule_fk'], ['schedule.id'], ),
    sa.ForeignKeyConstraint(['user_fk'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_audit_audit_commission_fk'), 'audit', ['audit_commission_fk'], unique=False)
    op.create_index(op.f('ix_audit_course_fk'), 'audit', ['course_fk'], unique=False)
    op.create_index(op.f('ix_audit_id'), 'audit', ['id'], unique=False)
    op.create_index(op.f('ix_audit_protocol_fk'), 'audit', ['protocol_fk'], unique=False)
    op.create_index(op.f('ix_audit_schedule_fk'), 'audit', ['schedule_fk'], unique=False)
    op.create_index(op.f('ix_audit_user_fk'), 'audit', ['user_fk'], unique=False)
    op.create_table('audit_commission_user',
    sa.Column('audit_commission_fk', sa.Integer(), nullable=False),
    sa.Column('user_fk', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['audit_commission_fk'], ['audit_commission.id'], ),
    sa.ForeignKeyConstraint(['user_fk'], ['user.id'], ),
    ...
    op.create_index(op.f('ix_audit_commission_user_audit_commission_fk'), 'audit_commission_user', ['audit_commission_fk'], unique=False)
    op.create_index(op.f('ix_audit_commission_user_user_fk'), 'audit_commission_user', ['user_fk'], unique=False)
    ...
    op.create_index(op.f('ix_user_course_course_fk'), 'user_course', ['course_fk'], unique=False)
    op.create_index(op.f('ix_user_course_user_fk'), 'user_course', ['user_fk'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_audit_commission_user_user_fk'), table_name='audit_commission_user')
    op.drop_index(op.f('ix_audit_commission_user_audit_commission_fk'), table_name='audit_commission_user')
    ...
    op.drop_index(op.f('ix_audit_commission_user_fk'), table_name='audit_commission')
    op.drop_index(op.f('ix_audit_commission_id'), table_name='audit_commission')
